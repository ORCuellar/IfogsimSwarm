...
public class ModulePlacementEdgewardsOld extends ModulePlacement{
    ...
    public ModulePlacementEdgewardsOld(List<FogDevice> fogDevices, List<Sensor> sensors, List<Actuator> actuators,
